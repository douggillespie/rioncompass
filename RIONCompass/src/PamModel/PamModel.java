...
//		mi.setMaxNumber(1); 
		...
		mi = PamModuleInfo.registerControlledUnit(RIONControl.class.getName(), "RION Compass");
		mi.setModulesMenuGroup(sensorsGroup);
		mi.setToolTipText("Reads Depth, Heading, Pitch and Roll) from RION Compass using serial data");
//		mi.setMaxNumber(1);
